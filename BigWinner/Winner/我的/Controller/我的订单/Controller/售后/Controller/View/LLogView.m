...
static NSString *const LLogCellid = @"LLogCell";
@interface LLogView ()<UIGestureRecognizerDelegate,UITableViewDelegate,UITableViewDataSource>
...
-(void)setLayout{
    ...
    [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(CGFloatBasedI375(0.5));
    }];
    ...
    [self.tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.offset(CGFloatBasedI375(54.5));
    }];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LLogCell *cell = [tableView dequeueReusableCellWithIdentifier:LLogCellid];
...
-(UITableView *)tableView{
    if(!_tableView){
        ...
        [ _tableView  registerClass:[LLogCell class] forCellReuseIdentifier:LLogCellid];
