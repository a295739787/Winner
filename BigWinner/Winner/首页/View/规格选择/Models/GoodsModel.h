...
@property(nonatomic, copy)NSString *priceSales;//商品标题
@property (nonatomic, copy) NSString *specsValName;
@property (nonatomic,assign) RoleStatus status;/** class **/
@property (nonatomic,assign) NSInteger purchaseRestrictions;/** class **/
...
@property (nonatomic,copy) NSString *scribingPrice;//原价
