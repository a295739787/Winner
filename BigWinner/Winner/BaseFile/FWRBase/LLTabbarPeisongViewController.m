...
@interface LLTabbarPeisongViewController ()<UITabBarDelegate,UITabBarControllerDelegate,UIGestureRecognizerDelegate>
/// 图片宽
...
@implementation LLTabbarPeisongViewController{
...
//添加所有的子控制器
-(void)addAllChildVcs{
    LLMainPeisongViewController *dating = [[LLMainPeisongViewController alloc] init];
    [self addOneChildVc:dating andTitle:@"任务大厅" andImageName:@"home_gray" andSelectedImageName:@"home_red"];
    LLStockPeisongViewController *classify = [[LLStockPeisongViewController alloc] init];
    [self addOneChildVc:classify andTitle:@"配送库存" andImageName:@"retail_gray" andSelectedImageName:@"retail_red"];

    LLMePersongViewController *shopcar = [[LLMePersongViewController alloc] init];
