...
- (void)drawRect:(CGRect)rect {
    ...
    self.font = [UIFont fontWithFontSize:self.fontSize];
    self.delegate = self;
}
...
- (UILabel *)placeholderLabel {
    ...
    _placeholderLabel.font = [UIFont fontWithFontSize:15];
...
- (void)setPlaceholderFontSize:(NSInteger)placeholderFontSize {
    ...
    self.placeholderLabel.font = [UIFont fontWithFontSize:placeholderFontSize];
}
