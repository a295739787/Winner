...
//    eg2
//    _formView = [[QMChatFormView alloc] init];
//    _formView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
//    [[UIApplication sharedApplication].keyWindow addSubview:_formView];
//    [_formView mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.edges.equalTo([UIApplication sharedApplication].keyWindow);
//    }];
//    _formView.formInfo = _formInfoArr;
    
//    eg3
//    QMChatFormViewController *formVC = [[QMChatFormViewController alloc] init];
//    UINavigationController *nv = [[UINavigationController alloc] initWithRootViewController:formVC];
//    nv.view.backgroundColor = UIColor.clearColor;

//    [formVC setFormInfo:_formInfoArr];
//    [[UIApplication sharedApplication].keyWindow presentViewController];
    
//    AppDelegate *appd = (AppDelegate *)[UIApplication sharedApplication].delegate;
//    UIViewController *vc = appd.window.rootViewController;
//    [vc presentViewController:formVC animated:YES completion:nil];
    
//    self.tapFlowSelectAction(_formInfoArr, YES);
    
    
//    if ([vc isKindOfClass:[UINavigationController class]]) {
//        [(UINavigationController *)vc pushViewController:formVC animated:true];
//    } else {
