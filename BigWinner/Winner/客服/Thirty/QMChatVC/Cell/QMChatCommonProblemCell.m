...
//    NSArray *itemArray = _listArray[self.selectedIndex];
...
//        _segmentView.originalIndex = [cellIndex integerValue];
        ...
        NSArray *itemArray = _listArray[cellIndex];
...
//    NSLog(@"targetPage===%ld===sourcePage===%ld===percent===%f",targetPage,(long)sourcePage,percent);
}
