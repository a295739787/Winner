...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"0"]) {
        ...
        _textLabel.frame = CGRectMake(15, 10, textSize.width, textSize.height);
        
        self.chatBackgroundView.frame = CGRectMake(QM_kScreenWidth - 67 - textSize.width - 30, CGRectGetMaxY(self.timeLabel.frame) + 25, textSize.width + 30, textSize.height + 20);
        ...
        CGSize textSize = [_textLabel preferredSizeWithMaxWidth:QMChatTextMaxWidth];
        _textLabel.frame = CGRectMake(15, 10, textSize.width, textSize.height);
        self.chatBackgroundView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame) + 25, textSize.width + 30, textSize.height + 20);
    }
}
