...
- (void)createUI {
    ...
    _textView.backgroundColor = [UIColor colorWithHexString:isDarkStyle ? QMColor_News_Agent_Dark : QMColor_News_Agent_Light];
    ...
    _textLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#D3D3D3" : QMColor_151515_text];
    [_textView addSubview:_textLabel];

    _completedImageView = [[UIImageView alloc] init];
    _completedImageView.image = isDarkStyle ? [UIImage imageNamed:@"QM_VoiceFinish_icon"] : [UIImage imageNamed:@"qm_chat_completed"];
    ...
    _completedLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#646464" : QMColor_999999_text];
