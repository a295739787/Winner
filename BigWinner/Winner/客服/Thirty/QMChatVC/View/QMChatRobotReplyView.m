...
- (void)setStatus:(NSString *)status {
    if ([status isEqualToString:@"none"]) {
        ...
        _helpLabel.textColor =  [UIColor colorWithHexString:@"#F8624F"];
        ...
        NSLog(@"    self.describeLbl.text == %@",    self.describeLbl.text);
...
- (void)createView {
    ...
    _noHelpLabel.textColor =[UIColor colorWithHexString:QMColor_News_Custom];
